...
default_config = {
    ...
    "save_name":"lora",
    "pretrained_model_name_or_path":"/kaggle/input/kwaikolors", # or local folder F:\Kolors
    "train_data_dir":"/kaggle/temp/",
    "vae_path":"/kaggle/input/sdxl-vae-fp16-fix/sdxl_vae.safetensors", # or local file
